...
with_node \
  ...
  --target "/Users/matthewriley/SkillsFile/SkillsFileApp/ios/Pods/Target Support Files/Pods-SkillsFileAppExpo/ExpoModulesProvider.swift" \
  --entitlement "/Users/matthewriley/SkillsFile/SkillsFileApp/ios/SkillsFileAppExpo/SkillsFileAppExpo.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-screen-orientation" "expo-sensors" "expo-splash-screen" "expo-sqlite" "expo-symbols" "expo-system-ui" "expo-web-browser"
